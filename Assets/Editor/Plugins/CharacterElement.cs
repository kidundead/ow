...
public class CharacterElement
{
    ...
    public bool IsLoaded
    {
        get
        {
            ...
            //Debug.Log("CharacterElement Loaded.. + " + this.name);
    ...
    public SkinnedMeshRenderer GetSkinnedMeshRenderer()
    {
        ...
        if (gameObjectRequest == null)
        {
            Debug.Log("gameObjectRequest is null..." + name);

        }
        else if (gameObjectRequest.asset == null)
        {
            Debug.Log("asset of gameObjectRequest is null...");
        }
